...
use zksync_types::{
    ...
    Address, L1BatchNumber, StorageLogWithPreviousValue, H256, U256,
};
...
// Intentionally omitted: high-level / oneshot transaction wrappers and metric helpers
// used by state-keeper / API paths outside this extracted verifier-focused workspace.
